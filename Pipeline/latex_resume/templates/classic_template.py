...
def _generate_education_section(education_list: Optional[List[Dict[str, Any]]]) -> Optional[str]:
    ...
    for edu in education_list:
        ...
        # Relevant coursework / additional info and unexpected extras as bullets to preserve layout
        ...
        # Add any extra string fields as their own bullets (e.g., "commencement speaker")
        ...
        for k, v in edu.items():
            ...
            if isinstance(v, str) and v.strip():
                if not item_list_started:
                    lines.append(r"      \resumeItemListStart")
                    item_list_started = True
                lines.append(f"        \\resumeItem{{{fix_latex_special_chars(v)}}}")
