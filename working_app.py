...
def create_app():
    ...
    def optimize_resume_endpoint():
        ...
        try:
            ...
            # Optional: whether to generate a job-specific summary for the resume
            generate_summary_raw = request.form.get("generate_summary", "false")
            generate_summary = str(generate_summary_raw).strip().lower() in ("true", "1", "yes", "on")
            ...
            response_received = enhance_resume(job_id, resume_id, user_id, job_description, generate_summary)
