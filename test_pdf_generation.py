#!/usr/bin/env python3
"""
Test script to validate PDF generation from dummy resume data.
This script tests the LaTeX generation and conversion to PDF
using a simplified version of the main application's approach.
"""
...
def main():
    ...
    tex_file_path = os.path.join(output_dir, f"resume_{timestamp}.tex")
